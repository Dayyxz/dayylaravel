import { ArrowPathIcon, ArrowDownIcon } from '@heroicons/react/20/solid'
...
const Footerz = () => {
  ...
  <div>
    ...
    <p>Its Me Dayy.<br/>© 2023 Muhammad D. Ristiansyah</p>
  </div> 
  <div>
  ...
  <div>
    ...
    <a className="link link-hover">Terms of use</a> <div className="form-control w-80">
